...
#'@param runs Numeric (default = 2). Specifies the number of times that the function should run the decontamination procedure on the data. Based on simulation results, using two runs is best on average.
#'@param low.threshold Numeric (default = 40). Selects the lower point for switching between the two decon functions (decon.regress1() and decon.regress2()). It uses decon.regress2 anytime that the estimated overlap is <low.threshold or >up.threshold.
#'@param up.threshold Numeric (default = 400). Selects the higher point for switching between the two decon functions (decon.regress1() and decon.regress2()). It uses decon.regress2 anytime that the estimated overlap is <low.threshold or >up.threshold.
#'
